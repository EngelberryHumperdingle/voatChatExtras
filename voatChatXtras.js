...
$(window).on('load', function() {
  ...
  var labelButton = '&nbsp; <button type="button" class="labelUser">label</button> <span class="labelOptions"> &nbsp; <input class="userLabel" type="text" name="userLabel" placeholder="ex: Shill" /> &nbsp; <input class="trigger" value="rgb(162, 63, 3)" /> &nbsp; <button type="button" class="addLabel">add</button> &nbsp; <a href="javascript:void(0)" class="fake">fake</a> | <a href="javascript:void(0)" class="shill">shill</a> | <a href="javascript:void(0)" class="bro">bro</a></span>';
